...
public class DeliveryPass {
    ...
    /**
     * If this pass was auto-created from a marketplace order, store the order
     * ID. null = manually created by resident (Swiggy, Amazon, etc.) non-null =
     * created by MarketplaceOrderService.markOutForDelivery()
     *
     * Used by guard screen to filter marketplace deliveries separately, and by
     * verifyOtp() to update the linked order's otpVerified flag.
     */
    ...
    public void setMarketplaceOrderId(Long v) {
        this.marketplaceOrderId = v;
    }
