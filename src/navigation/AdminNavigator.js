...
// Maintenance
import AdminMaintenance from '../screens/admin/maintenance/AdminMaintenanceScreen';
...
// SOS (shared guard screen — admin can monitor)
...
function AdminStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false, animation: 'slide_from_right' }}>
      ...
      {/* SOS monitoring */}
      <Stack.Screen name="SOSAdmin" component={SOSScreen} />
    </Stack.Navigator>
  );
}
