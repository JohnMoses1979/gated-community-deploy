...
import DeliveryStaffListScreen from '../screens/vendor/delivery/DeliveryStaffListScreen';
import AddDeliveryStaffScreen from '../screens/vendor/delivery/AddDeliveryStaffScreen';
// Notifications
...
function VendorStack() {
  ...
  return (
    <Stack.Navigator initialRouteName={initialRoute} screenOptions={{ headerShown: false, animation: 'slide_from_right' }}>
      ...
      <Stack.Screen
        name="VendorDeliveryStaffList"
        component={DeliveryStaffListScreen}
        options={{ title: 'Delivery Helpers' }}
      />

      <Stack.Screen
        name="AddDeliveryStaff"
        component={AddDeliveryStaffScreen}
        options={{ title: 'Add Delivery Helper' }}
      />
      {/* Notifications */}
